...
public class WithdrawCommand {
    ...
    /*
     @TargetAggregateVersion is used to indicate the expected version of the Aggregate.If the version is different conflict occurs.
     It runs ConflictResolver.detectConflicts
     */
